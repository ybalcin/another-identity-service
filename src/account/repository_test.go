...
func TestInsertNewUser(t *testing.T) {
	...
	mock_repo.InsertNewUserFn = func(user *user) *common.FriendlyError {
		return nil
	}

	new_user, _ := CreateNewUser(NewUserId(), "testname", "testlastname", "testusername", "test@gmail.com", "123456", time.Now().UTC(),
